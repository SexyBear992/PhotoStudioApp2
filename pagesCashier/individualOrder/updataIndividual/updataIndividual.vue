	...
	<view>
		<view class="bigBox">
			...
			<view class="listBox">
				...
				<view class="text" v-if="detials">{{detials.contactName}}</view>
			</view>
			
			<!-- 客户电话 -->
			<view class="listBox">
				<view class="title">客户电话</view>
				<view class="text" v-if="detials">{{detials.contactMobile}}</view>
			</view>
			
			<!-- 客户微信 -->
			<view class="listBox">
				<view class="title">客户微信</view>
				<view class="text" v-if="detials">{{detials.contactWechat}}</view>
			</view>
