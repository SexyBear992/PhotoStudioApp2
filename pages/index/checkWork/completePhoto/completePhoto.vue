...
<script>
	...
	import shopModule from '@/pages/index/arrange/components/shopModule.vue'
	import processModule from '@/pages/index/arrange/components/processModule.vue'
	import videoModule from '@/pages/index/arrange/components/videoModule.vue'
