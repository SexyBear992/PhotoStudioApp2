	...
	<view>
		<view class="bigBox">
			...
			<view class="listBox">
				...
				<modifyPicker class="picker" :changeId="openInfo.orderCategoryId" :categoryName="'get_orderTypeArr'" :getId.sync="openInfo.orderCategoryId"></modifyPicker>
			</view>

			<!-- 订单分组 -->
			<view class="listBox">
				<view class="title">订单分组</view>
				<modifyPicker class="picker" :changeId="openInfo.groupCategoryId" :categoryName="'get_orderGroup'" :getId.sync="openInfo.groupCategoryId"></modifyPicker>
			</view>
