...
<template>
	<view>
		<view class="inpBox">
			...
			<good :index="index" @getItem="getGood"></good>
			<dress :index="index" @getItem="getDress"></dress>
			<place :index="index" @getItem="getPlace"></place>
			<service :index="index" @getItem="getService"></service>
		</view>
	</view>
</template>
